// Archivo: lib/screens/yo_nunca/yo_nunca_screen.dart
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: const Text(
                  '¡Quienes SÍ lo hayan hecho, beben! 🍻',
                  style: TextStyle(
                    fontSize: 14,
              ...
              if (Platform.isAndroid || Platform.isIOS)
                Align(
                  ...
                  child: UnityBannerAd(
                    ...
                    onLoad: (placementId) => print('Banner YN cargado: $placementId'),
                    onFailed: (placementId, error, message) => print('Error Banner YN: $message'),
                  ),
                ),
            ],
          ),
